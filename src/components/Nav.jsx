    ...
    <header className="sticky top-0 z-50 border-b border-ink/5 bg-paper/85 backdrop-blur">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
        ...
        <div className="hidden items-center gap-3 md:flex">
          <a href="#login" className="text-sm font-medium text-ink/70 hover:text-ink">
            로그인
          </a>
        ...
        <div className="border-t border-ink/5 bg-paper px-6 pb-6 md:hidden">
          <nav className="flex flex-col gap-4 pt-4">
            ...
            <a href="#login" className="text-sm font-medium text-ink/70">
              ...
              href="#cta"
              className="rounded-full bg-ink px-4 py-2 text-center text-sm font-semibold text-paper"
